...
ASMPTR(D2CLIENT, CongratsScreen_I, 0xD034)
...
// TODO
// FUNCPTR(D2COMMON, GetMissileOwnerUnit, UnitAny *__fastcall, (UnitAny * pMissile), 0x639D0) // 1.14d 0x639D0 , 1.13d??
////////////////////////////////////////////////////////////////////////////////////////////////
// D2Common Globals
////////////////////////////////////////////////////////////////////////////////////////////////
...
FUNCPTR(D2WIN, SetControlText, void *__fastcall, (Control * box, const wchar_t *txt), 0x10680)
...
FUNCPTR(D2WIN, InitMPQ, DWORD __stdcall, (const char *dll, const char *mpqfile, char *mpqname, int v4, int v5), 0x7E50)
