declare module "boot" {
  ...
  declare function getPlayerFlag(
    meGid: number,
    otherGid: number,
    type: number
  ): boolean;
  ...
  declare function addEventListener(
    eventType: "gamepacket",
    callback: (bytes: ArrayBufferLike) => boolean
  ): void;
  declare function addEventListener(
    eventType: "scriptmsg",
    callback: (data: string | object | number) => void
  ): void;
  declare function addEventListener(
    eventType: "copydata",
    callback: (mode: number, msg: string) => void
  ): void;
  declare function addEventListener(
  ...
  declare class Hash {
    ...
    md5_file(str: string): string;
    sha1_file(str: string): string;
    sha256_file(str: string): string;
    sha384_file(str: string): string;
    sha512_file(str: string): string;
  }

  /**
   * @param align  0:Left, 1: Right, 2: Center
   */
  declare class Text {
    constructor(
      text: string,
