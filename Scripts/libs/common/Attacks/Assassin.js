...
export const ClassAttack = {
  ...
  checkTraps(unit) {
    ...
    if (
      me.getMinionCount(sdk.summons.type.AssassinTrap) === 0 ||
      !this.lastTrapPos.hasOwnProperty("x") ||
