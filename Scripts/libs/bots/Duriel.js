import { delay, getRoom, me, say } from "boot";
import { sdk } from "../modules/sdk.js";
import { Config } from "../common/Config.js";
import { Misc, Skill, Game } from "../common/Misc.js";
...
export const Duriel = function () {
  this.killDuriel = function () {
    let target = Misc.poll(
      () => Game.getMonster(sdk.monsters.Duriel),
      1000,
      200
    );
    ...
    Config.MFLeader &&
      Pather.makePortal() &&
      say(`kill ${sdk.monsters.Duriel}@${me.area}`);
  ...
  if (
    ...
    (!unit || !Pather.useUnitEx({ unit: unit }, sdk.areas.DurielsLair))
  ) {
    Attack.clear(10);
    Pather.useUnit(
      sdk.unittype.Object,
