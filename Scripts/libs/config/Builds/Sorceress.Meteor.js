...
export const AutoBuildTemplate = {
  ...
  3: {
    SkillPoints: [37], // Fire Bolt + 1 (level 2)
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function () {},
  },

  4: {
    SkillPoints: [-1], // Warmth + 1 (level 1)
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function () {},
  },
  ...
  7: {
    SkillPoints: [43], // Telekinesis + 1 (level 1), Static Field + 1(level 2) (Normal Den of Evil Used)
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function () {
  ...
  8: {
    SkillPoints: [-1], // Fire Bolt + 1 (level 3)
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function () {},
  },
  ...
  12: {
    SkillPoints: [-1], // Inferno + 1 (level 1), Blaze + 1 (level 1), Fire Ball +1 (level 1) ,0 Save
  ...
  14: {
    SkillPoints: [-1], // Static Field + 1 (level 4)
    StatPoints: [3, 3, 3, 3, 3], // Strength + 1, Vitality + 4
    Update: function () {},
  },
  ...
  17: {
    SkillPoints: [-1], // Teleport +1 (level 1)
    StatPoints: [3, 3, 3, 3, 3], // Strength + 1, Vitality + 4
    Update: function () {},
  },
  ...
  19: {
    SkillPoints: [47, 54], // Fire Ball +1 (level 4)
    StatPoints: [3, 3, 3, 3, 3], // Strength + 1, Vitality + 4
    Update: function () {},
  },
  ...
  24: {
    SkillPoints: [-1], // Meteor + 1 (level 1)
    StatPoints: [0, 0, 0, 0, 0], // Strength 40
    Update: function () {
      Config.AttackSkill = [-1, 59, 45, 59, 45, 47, 47]; // blizzard + Fire Ball
  ...
  25: {
    SkillPoints: [-1], // Meteor + 1 (level 2)
  ...
  26: {
    SkillPoints: [-1], // Meteor + 1 (level 3)
    StatPoints: [0, 0, 0, 0, 0], // Strength 50
    Update: function () {},
  },

  27: {
    SkillPoints: [-1], // Static Field + 1 (level 6) Save + 1 (3 saved points remain) (Norm Radament)
    StatPoints: [3, 3, 3, 3, 3], // Strength + 1, Vitality + 4
    Update: function () {},
  },

  28: {
    SkillPoints: [-1], // Meteor + 1 (level 4)
    StatPoints: [3, 3, 3, 3, 3], // Strength + 1, Vitality + 4
    Update: function () {
  ...
  29: {
    SkillPoints: [-1], // Meteor + 1 (level 5)
