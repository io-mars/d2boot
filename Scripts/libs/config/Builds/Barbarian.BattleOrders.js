...
export const AutoBuildTemplate = {
  ...
  6: {
    SkillPoints: [sdk.skills.DoubleSwing, sdk.skills.Shout], // Shout + 1, Leap + 1 (level 1) (level 1) (1 saved point remains)
    Update: function () {
  ...
  12: {
    SkillPoints: [sdk.skills.DoubleThrow, sdk.skills.IncreasedStamina], // Find Item + 1, Increased Stamina + 1 (level 1) (level 1) (0 saved points remain)
    Update: function () {
  ...
  18: {
    SkillPoints: [sdk.skills.IronSkin], // Iron Skin + 1 (level 1)
    Update: function () {
  ...
  24: {
    SkillPoints: [
      ...
      sdk.skills.Frenzy,
      sdk.skills.IncreasedSpeed,
    ], // Battle Orders + 1, Increased Speed + 1 (level 1) (level 1) (0 saved points remain)
    Update: function () {
      Config.AttackSkill = [
        -1,
        sdk.skills.Frenzy,
  ...
  30: {
    SkillPoints: [sdk.skills.BattleCommand, sdk.skills.NaturalResistance], // Battle Command + 1, Natural Resistance + 1 , Leap + 2 (level 1) (level 1) (level 6) (Norm Izual)
    Update: function () {
