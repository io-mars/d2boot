...
export const AutoBuildTemplate = {
  ...
  6: {
    ...
    Update: function () {
      Config.AttackSkill = [
        ...
        sdk.skills.HolyBolt,
        sdk.skills.Might,
      ]; // Holy Bolt and Might for Secondary Skill/Aura.
    },
  },
  ...
  18: {
    ...
    Update: function () {
      ...
      Config.LowManaSkill = [sdk.skills.Smite, sdk.skills.Concentration]; //
  ...
  30: {
    SkillPoints: [sdk.skills.Meditation, sdk.skills.Redemption], //
    Update: function () {
