...
export const LoadConfig = function () {
  ...
  Config.AttackSkill[1] = sdk.skills.Whirlwind; // Primary skill to bosses.
  Config.AttackSkill[2] = sdk.skills.Whirlwind; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[1] is untimed skill.
  Config.AttackSkill[3] = sdk.skills.Whirlwind; // Primary skill to others.
  Config.AttackSkill[4] = sdk.skills.Whirlwind; // Primary untimed skill to others. Keep at -1 if Config.AttackSkill[3] is untimed skill.
  Config.AttackSkill[5] = sdk.skills.Berserk; // Secondary skill if monster is immune to primary.
  Config.AttackSkill[6] = sdk.skills.Berserk; // Secondary untimed skill if monster is immune to primary untimed.
  ...
  Config.AutoBuild.Template = "Whirlwind"; //	The name of the build associated with an existing
};
