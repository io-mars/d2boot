import { print, getControl } from "boot";
import { sdk } from "./sdk.js";
import { ControlAction } from "@/OOG.js";
...
function Control(type, x, y, xsize, ysize) {
  ...
  return new Proxy(this, {
    get: function (target, p) {
      ...
      if (typeof control === "object" && control && p in control) {
        return control[p];
      }
...
Control.D2SplashCopyright = new Control(
  sdk.controls.LabelBox,
  100,
  580,
  600,
  80
...
Control.MainMenuCinematics = new Control(
  sdk.controls.Button,
  402,
  528,
  135,
...
Control.LoginInvalidCdKey = new Control(
  sdk.controls.LabelBox,
  162,
  270,
  477,
...
Control.LoginCdKeyInUseBy = new Control(
  sdk.controls.LabelBox,
  158,
  310,
  485,
...
Control.LoginUnableToConnect = new Control(
  sdk.controls.LabelBox,
  158,
  220,
  485,
...
Control.LoginAccountSettings = new Control(
  sdk.controls.Button,
  264,
  528,
  272,
...
Control.OtherMultiplayerCancel = new Control(
  sdk.controls.Button,
  264,
  568,
  272,
...
Control.CreateNewAccountName = new Control(
  sdk.controls.TextBox,
  322,
  342,
  162,
  19
);
Control.CreateNewAccountPassword = new Control(
  sdk.controls.TextBox,
  322,
  396,
  162,
...
Control.CreateNewAccountConfirmPassword = new Control(
  sdk.controls.TextBox,
  322,
  450,
  162,
...
Control.CreateNewAccountOk = new Control(
  sdk.controls.Button,
  627,
  572,
  128,
...
Control.CreateNewAccountExit = new Control(
  sdk.controls.Button,
  33,
  572,
  128,
...
Control.TermsOfUseDisagree = new Control(
  sdk.controls.Button,
  133,
  513,
  128,
...
Control.EmailDontRegisterContinue = new Control(
  sdk.controls.Button,
  415,
  412,
  128,
...
Control.CharSelectCharInfo0 = new Control(
  sdk.controls.LabelBox,
  37,
  178,
  200,
...
Control.CharSelectCurrentRealm = new Control(
  sdk.controls.LabelBox,
  626,
  100,
  151,
...
Control.CharCreateCharName = new Control(
  sdk.controls.TextBox,
  318,
  510,
  157,
...
Control.CharCreateExpansion = new Control(
  sdk.controls.Button,
  319,
  540,
  15,
...
Control.CharCreateHCWarningOk = new Control(
  sdk.controls.Button,
  421,
  337,
  96,
...
Control.CharCreateHCWarningCancel = new Control(
  sdk.controls.Button,
  281,
  337,
  96,
...
Control.LobbyCharacterInfo = new Control(
  sdk.controls.LabelBox,
  143,
  588,
  230,
...
Control.JoinGameDetails = new Control(
  sdk.controls.LabelBox,
  609,
  393,
  143,
...
Control.CharacterDifferenceButton = new Control(
  sdk.controls.Button,
  431,
  341,
  15,
...
Control.CharacterDifference = new Control(
  sdk.controls.TextBox,
  657,
  342,
  27,
...
Control.CreateGameInLine = new Control(
  sdk.controls.LabelBox,
  427,
  234,
  300,
...
Control.LobbyChannelWhisper = new Control(
  sdk.controls.Button,
  107,
  470,
  80,
...
Control.LobbyChannelUnsquelch = new Control(
  sdk.controls.Button,
  99,
  490,
  96,
...
Control.LobbyChannelChar10 = new Control(
  sdk.controls.Button,
  640,
  591,
  60,
...
Control.LobbyServerDown = new Control(
  sdk.controls.LabelBox,
  438,
  300,
  326,
